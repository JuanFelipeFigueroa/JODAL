...
function modificarEstado() {
	...
	if (btnestado.innerHTML == 'ACTIVO') {

		btnestado.innerHTML = 'INACTIVO';
		btnestado.style.backgroundColor = 'firebrick';
		btnestado.style.boxShadow = '0px 0px 10px firebrick';
	}
	else{
		btnestado.innerHTML = 'ACTIVO';
		btnestado.style.backgroundColor = '';
		btnestado.style.boxShadow = '';
	}
}