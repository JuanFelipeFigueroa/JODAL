...
<body>
	...
	<div id="contMenuVert" class="C1">
		<div class="menuVertical flex">
			...
			<div class="contModulos">
				<button class="modulo C1 H2" onclick="modulosAsistente(0)">AGENDAMIENTO</button>
				<button class="modulo C1 H2" onclick="modulosAsistente(1)">COLABORADORES</button>
				<button class="modulo C1 H2" onclick="modulosAsistente(2)">EXISTENCIAS</button>
				<button class="modulo C1 H2" onclick="modulosAsistente(3)">PRODUCTOS</button>
			</div>

			<div class="logo"><img src="../../../../logos/blanco.png" alt="logo"></div>

			<a class="btnCerrarSesion C4" href="../../../../index.php">CERRAR SESIÓN</a>
	...
	<div id="mainV">
		...
		<div id="usuario" class="flex C3">ASISTENTE</div>

		<button id="controlMenuOff" class="C1" onclick="menuOff()"><img 
			src="../../../../iconos/menuwhite30-min.png"
				alt="menu"></button>

		<button id="controlMenuOn" class="C1" onclick="menuOn()"><img 
			src="../../../../iconos/menuwhite30-min.png"
				alt="menu"></button>
